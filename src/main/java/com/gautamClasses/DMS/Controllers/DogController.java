package com.gautamClasses.DMS.Controllers;
...
import com.gautamClasses.DMS.Models.Trainer;
import com.gautamClasses.DMS.repositoy.DogRepository;
import com.gautamClasses.DMS.repositoy.TrainerRepository;
...
//		return home();
		...
		Dog dogFound = dogRepo.findById(dog.getId()).orElse(new Dog());
